...
Preprocessing includes: normalization of text, tokenization of text, removal of stop word tokens, lemmatization and stemming of tokens.
...
def preprocess_text(text):
    ...
    stems, uppercase letters, and where the words are lemmatized if possible.
    """
